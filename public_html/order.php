                      ...
                      <ul class="dropdown-list order-props-dropdown-list">
                        <li class="dropdown-item order-props-dropdown-item">
                          <button class="dropdown__value dropdown__value_selected order-props-dropdown-item__value"
                              ...
                              class="dropdown__value-text order-props-dropdown-item__value-text">11:00-12:00</span>
                          </button>
                        </li>
                        <li class="dropdown-item order-props-dropdown-item">
                          <button class="dropdown__value order-props-dropdown-item__value" type="button"
                                  data-value="12:00-13:00"><span
                              class="dropdown__value-text order-props-dropdown-item__value-text">12:00-13:00</span>
                          </button>
                        </li>
                        <li class="dropdown-item order-props-dropdown-item">
                          <button class="dropdown__value order-props-dropdown-item__value" type="button"
                                  data-value="14:00-15:00"><span
                              class="dropdown__value-text order-props-dropdown-item__value-text">14:00-15:00</span>
                          </button>
                        </li>
                        <li class="dropdown-item order-props-dropdown-item">
                          <button class="dropdown__value order-props-dropdown-item__value" type="button"
                                  data-value="15:00-16:00"><span
                              class="dropdown__value-text order-props-dropdown-item__value-text">15:00-16:00</span>
                          </button>
                        </li>
                        <li class="dropdown-item order-props-dropdown-item">
                          <button class="dropdown__value order-props-dropdown-item__value" type="button"
                                  data-value="16:00-17:00"><span
                              class="dropdown__value-text order-props-dropdown-item__value-text">16:00-17:00</span>
                          </button>
                        </li>
                        <li class="dropdown-item order-props-dropdown-item">
                          <button class="dropdown__value order-props-dropdown-item__value" type="button"
                                  data-value="17:00-18:00"><span
                              class="dropdown__value-text order-props-dropdown-item__value-text">17:00-18:00</span>
                          </button>
                        </li>
                        <li class="dropdown-item order-props-dropdown-item">
                          <button class="dropdown__value order-props-dropdown-item__value" type="button"
                                  data-value="19:00-20:00"><span
                              class="dropdown__value-text order-props-dropdown-item__value-text">19:00-20:00</span>
                          </button>
                        </li>
                        <li class="dropdown-item order-props-dropdown-item">
                          <button class="dropdown__value order-props-dropdown-item__value" type="button"
                                  data-value="20:00-21:00"><span
                              class="dropdown__value-text order-props-dropdown-item__value-text">20:00-21:00</span>
                          </button>
                        </li>
                        <li class="dropdown-item order-props-dropdown-item">
                          <button class="dropdown__value order-props-dropdown-item__value" type="button"
                                  data-value="21:00-22:00"><span
                              class="dropdown__value-text order-props-dropdown-item__value-text">21:00-22:00</span>
                          </button>
                        </li>
                      </ul>
                    </div>
